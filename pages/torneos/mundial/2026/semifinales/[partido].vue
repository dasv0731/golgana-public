...
useSeo({
  title: `${titleByState[partido.value.estado]} | Mundial 2026 Semifinales`,
  description:
    partido.value.previa?.texto.replace(/<[^>]+>/g, '').slice(0, 160) ??
    `${partido.value.local.nombre} vs ${partido.value.visitante.nombre} en semifinales del Mundial 2026.`,
});
